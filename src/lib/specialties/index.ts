...
export const SPECIALTY_DEFINITIONS: Record<SpecialtyName, SpecialtyDefinition> = {
  oncology: {
    ...
    preferredAgents: ['medical-necessity', 'correction-engine', 'appeal-strategist', 'prior-authorization'],
    hasJCodes: true,
  ...
  cardiology: {
    ...
    denialRiskLevel: 'critical',
    commonDenialCategories: ['bundling', 'medical_necessity', 'authorization', 'coding_error'],
    preferredAgents: ['medical-necessity', 'correction-engine', 'prior-authorization'],
    hasJCodes: false,
  ...
  orthopedics: {
    ...
    preferredAgents: ['medical-necessity', 'correction-engine', 'appeal-strategist'],
    hasJCodes: false,
    hasTimeBasedCoding: false,
    hasGlobalPeriods: true,
  },
  gastroenterology: {
    ...
    preferredAgents: ['correction-engine', 'medical-necessity'],
    hasJCodes: false,
    hasTimeBasedCoding: false,
    hasGlobalPeriods: true,
  },
  ...
  anesthesiology: {
    ...
    preferredAgents: ['correction-engine'],
    hasJCodes: false,
    hasTimeBasedCoding: true,
    hasGlobalPeriods: false,
  },
  ...
  pulmonology: {
    ...
    preferredAgents: ['medical-necessity', 'correction-engine'],
    hasJCodes: false,
    hasTimeBasedCoding: true,
    hasGlobalPeriods: false,
  },
  ...
  behavioral_health: {
    ...
    preferredAgents: ['medical-necessity', 'prior-authorization', 'correction-engine'],
    hasJCodes: false,
    hasTimeBasedCoding: true,
    hasGlobalPeriods: false,
  },
  ...
  dental: {
    ...
    preferredAgents: ['eligibility-cob', 'correction-engine'],
    hasJCodes: false,
    hasTimeBasedCoding: false,
    hasGlobalPeriods: false,
  },
  ...
  general: {
    ...
    preferredAgents: ['denial-analyzer', 'correction-engine'],
    hasJCodes: false,
    hasTimeBasedCoding: false,
    hasGlobalPeriods: false,
  },
...
export function getSpecialtyAgentConfig(specialty: SpecialtyName): SpecialtyAgentConfig {
  ...
  const configs: Partial<Record<SpecialtyName, Partial<SpecialtyAgentConfig>>> = {
    oncology: {
      primaryAgents: ['medical-necessity', 'correction-engine', 'prior-authorization'],
      secondaryAgents: ['appeal-strategist', 'evidence-retrieval', 'compliance-audit'],
    ...
    cardiology: {
      primaryAgents: ['medical-necessity', 'correction-engine', 'prior-authorization'],
      secondaryAgents: ['appeal-strategist', 'evidence-retrieval'],
